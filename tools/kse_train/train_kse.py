...
def parse_args():
    ...
    parser.add_argument('--config', default ='/home/changkang.li/mmclassification-master/acheckpoint/kse/resnet18kse/config.py',help='train config file path')
...
def main():
    args = parse_args()
    args.config = '/home/changkang.li/mmclassification-master/acheckpoint/kse/resnet18kse/config.py'
    args.work_dir = '/home/changkang.li/mmclassification-master/acheckpoint/kse/resnet18kse'
    args.gpus = 1
