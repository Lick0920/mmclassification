...
log_level = 'INFO'
load_from = None
resume_from = 'acheckpoint/in1k/res_depnetv1d18_in1k_bs256lr_bs32real_gpu8_baseline/latest.pth'
workflow = [('train', 1)]
work_dir = 'acheckpoint/in1k/res_depnetv1d18_in1k_bs256lr_bs32real_gpu8_baseline'
gpu_ids = range(0, 8)
